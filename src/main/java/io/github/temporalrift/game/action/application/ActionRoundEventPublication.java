...
public final class ActionRoundEventPublication {
     ...
     * publisher.
     */
    public static void publish(ActionRound round, ActionEventPublisher actionEventPublisher) {
        ...
        for (var payload : round.pullEvents()) {
            publishExternal(round, payload, actionEventPublisher);
            actionEventPublisher.publishInternally(payload);
        }
    }

    private static void publishExternal(ActionRound round, Object payload, ActionEventPublisher publisher) {
        switch (payload) {
